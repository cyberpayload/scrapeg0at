...
import rstr
import time
#This program is to scrape data about job postings
...
lStripName = (Name.lstrip(["'"]))
rStripName = (lStripName.rstrip(["'"]))
print(str(fullName) + "\'s occupation is a " + str(rStripName), end="")
